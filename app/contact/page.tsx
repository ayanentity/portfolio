      ...
      <main className="relative min-h-screen pb-16 pt-24 md:pt-28">
          ...
          <RevealOnScroll delay={0.12}>
            <div className="flex items-center gap-4 text-sm text-[#2F2F2F]">
              ...
              <a
                ...
                className="inline-flex h-8 w-8 items-center justify-center rounded-full transition-transform duration-200 hover:scale-110 motion-reduce:hover:scale-100"
              >
                <Image
        ...
        <RevealOnScroll delay={0.08}>
          <div className="mt-10 grid gap-4 md:hidden">
            <div className="relative h-52 overflow-hidden bg-slate-100 transition-transform duration-300 ease-out motion-reduce:transform-none hover:scale-[1.01]">
              <Image
